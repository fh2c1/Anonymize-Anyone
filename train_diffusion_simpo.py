...
VALIDATION_PROMPTS = [
    ...
    # "An Asian male university student with round glasses and a friendly expression. Short black hair. 4k, realistic photo.",
    # "An elderly Asian man with white hair and a wise, gentle look. Deep laugh lines. 4k, realistic photo.",
    # "A young Asian man with a stylish undercut hairstyle and a subtle goatee. Athletic build. 4k, realistic photo.",
    # "A young Asian woman with long, straight black hair and bright almond-shaped eyes. Soft smile. no beard. 4k, realistic photo.",
    # "An Asian businesswoman in her 40s with short, professional haircut and determined expression. Wearing a blazer. no beard. 4k, realistic photo.",
    # "A teenage Asian girl with braces and a cheerful grin. Hair in a high ponytail. no beard. 4k, realistic photo.",
    # "An elderly Asian woman with silver hair in a bun, kind eyes, and weathered skin. Warm smile. no beard. 4k, realistic photo.",
    # "A stylish Asian woman in her 30s with highlighted hair and winged eyeliner. Confident pose. no beard. 4k, realistic photo.",

    # # Diverse Background
    # "An Asian man in his early 20s standing in front of a traditional Japanese temple. 4k, realistic photo.",
    # "A middle-aged Asian businessman in a busy city street during the evening rush hour. 4k, realistic photo.",
    # "An Asian male university student studying in a modern library. 4k, realistic photo.",
    # "A young Asian woman with long, straight black hair, illuminated by soft morning light. 4k, realistic photo.",
    # "An elderly Asian woman with silver hair, lit by warm sunset light. 4k, realistic photo.",
    # "A stylish Asian woman in her 30s, under bright neon lights at night. 4k, realistic photo.",

    # # Diverse Emotion
    # "A young Asian man with a stylish undercut hairstyle and a broad, happy smile. 4k, realistic photo.",
    # "An Asian businesswoman in her 40s with a thoughtful and serious expression. 4k, realistic photo.",
    # "A teenage Asian girl with braces, laughing with joy. 4k, realistic photo.",

    # # Diverse Activity
    # "A young Asian woman with long, straight black hair, jogging in a park. 4k, realistic photo.",
    # "An elderly Asian man with white hair, practicing Tai Chi in a garden. 4k, realistic photo.",
    # "An Asian male university student with round glasses, giving a presentation in a classroom. 4k, realistic photo.",

    # # Combination of traditional and modern elements"
    # "An Asian woman in traditional Korean hanbok, standing in a modern cityscape. 4k, realistic photo.",
    # "An elderly Asian man with white hair, wearing a traditional Chinese robe, in a contemporary home. 4k, realistic photo.",
    # "A young Asian man with a stylish undercut hairstyle, holding a traditional Japanese fan. 4k, realistic photo.",

    # # Diverse age and sex
    # "A young Asian girl with short hair and a big smile, wearing a colorful dress. 4k, realistic photo.",
    # "An elderly Asian woman with a cane, walking in a beautiful garden. 4k, realistic photo.",
    # "An Asian boy playing soccer in a park, wearing a sports uniform. 4k, realistic photo.",
    # "A middle-aged Asian woman with a warm smile, cooking in a modern kitchen. 4k, realistic photo.",

    # # Diverse race and culture
    # "A young Black man with short curly hair and a confident smile. 4k, realistic photo.",
    # "A middle-aged Hispanic woman with wavy hair and a warm expression. 4k, realistic photo.",
    # "A Caucasian teenage boy with freckles and a playful grin. 4k, realistic photo.",
    # "An elderly Native American man with long gray hair and a serene look. 4k, realistic photo.",
    # "A Middle Eastern woman wearing a hijab and a gentle smile. 4k, realistic photo.",
    # "A young Indian girl with braided hair and traditional clothing. 4k, realistic photo.",
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=float, 
        default=0.1, 
        help="The beta parameter for SimPO."
    )
    parser.add_argument("--gamma_beta_ratio",
        type=float, 
        default=0.25, 
        help="The gamma/beta ratio for SimPO."
    )
    parser.add_argument(
        "--loss_type",
        type=str,
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                # Final loss by SimPO 
                pi_logratios = model_losses_l - model_losses_w
                logits = pi_logratios - args.gamma_beta_ratio

                if args.loss_type == "sigmoid":
                    losses = -F.logsigmoid(args.beta * logits)
                    loss = losses.mean()
                elif args.loss_type == "hinge":
                    losses = torch.relu(1 - args.beta * logits)
                    loss = losses.mean()                
                else:
                    raise ValueError(f"Unknown loss type {args.loss_type}")
                
                implicit_acc = (pi_logratios > 0).float().mean()
            ...
            logs = {
                ...
                "chosen_rewards": (args.beta * -model_losses_w).mean().detach().item(),
                "rejected_rewards": (args.beta * -model_losses_l).mean().detach().item(),
